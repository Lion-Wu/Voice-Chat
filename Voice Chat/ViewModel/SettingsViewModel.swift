...
class SettingsViewModel: ObservableObject {
    ...
    @Published var selectedPresetID: UUID? {
        didSet {
            if !suppressPresetDidSet {
                ...
                // Reload the selected preset fields after switching
    ...
    // Prevent recursive didSet when toggling presets
    ...
    func saveServerSettings() {
        // Maintain writes for legacy fields (ref/prompt_* are compatibility only).
    ...
    private func savePresetFields() {
        ...
        // Refresh the list to reflect potential name changes
        reloadPresetListAndSelection()
    }
